...
while True:
    try:
        ...
        if opcion == 1:
            if usuario1 == None:
                print("No hay usuarios registrados, por favor seleccione opción 2")
            else:
                usuario = input("Ingrese usuario: ")
                contraseña = input("Ingrese contraseña: ")
                if (usuario1 == usuario and contraseña == contrasena1 ) or (usuario == usuario2 and contraseña == contrasena2) or (usuario == usuario3 and contraseña==contrasena3):
                    ...
                    while True:
                        ...
                        if opcionMenu2 == 1 :
                            while True:
                                numero = input("Ingrese número de celular: ")
                                if numero.startswith("9") and len(numero) == 9 :
                                    print("Llamada realizada a ",numero)
                                    break
                                else:
                                    print("Número de celular debe comenzar con 9 o de largo 9")
                        else:
                            if opcionMenu2 == 2 :
                                while True:
                                    ...
                                    for caracter in correo: # h o l a
                                        ...
                                        if caracter == "@":
                                            ...
                                            valida = False
                                    if valida == False:
                                        print("correo inválido , debe tener un @")
                                    else:
                                        if valida: # valida == True
                                            mensaje = input("Ingrese un mensaje: ")
                                            print("Correo enviado a ",correo, " con mensaje => ",mensaje)
                                            break
                            else:
                                if opcionMenu2 == 3: 
            ...
            if opcion == 2:
                ...
                if opcion == 3 :
                    ...
                    print("Opción no válida, debe estar entre 1 y 3")

    except ValueError:
        print("Debe ingresar un numero válido para el menú")
